...
回答：   
In the recently years, gas has begun to be widely used in power generation in both manufacturing and commercial.Accurate prediction of the gas consumption could benefit us on several aspects:   
(1). Energy Saving.Knowing the gas demand could drive us to product the energy sources more efficiently. Unnecessary waste could be reduced.       
